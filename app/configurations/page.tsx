        ...
        <section className='mb-12'>
          ...
          <div className='grid lg:grid-cols-2 gap-6'>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/configurations/globalAssets'>
                  <GlobalAssets />
                </ViewComponent>
              </div>
            </div>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/configurations/stateProgram'>
                  <StateProgram />
                </ViewComponent>
              </div>
            </div>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/configurations/loadTheme'>
                  <LoadTheme />
                </ViewComponent>
              </div>
            </div>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/configurations/loadProgram'>
                  <LoadProgram />
                </ViewComponent>
              </div>
            </div>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/configurations/loadProgram-v2'>
                  <LoadProgramV2 />
                </ViewComponent>
              </div>
            </div>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/configurations/selectWhatsapp'>
                  <SelectWhatsapp />
                </ViewComponent>
              </div>
            </div>
            ...
            <div className='bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm'>
              ...
              <div className='p-4'>
                <ViewComponent path='/common/splash'>
                  <Splash />
                </ViewComponent>
              </div>
            </div>
