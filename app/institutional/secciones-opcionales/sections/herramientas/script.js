...
export default function swiperCarousel() {
  ...
  const reorganizeToHexagonal = () => {
    ...
    columnConfig.forEach((elementIndexes, columnIndex) => {
      ...
      // AGREGAR CLASES ESPECÍFICAS PARA CENTRADO
      if (totalItems === 5) {
        if (columnIndex === 1) {
          // Columna central con 1 elemento
      ...
      if (totalItems === 7) {
        if (columnIndex === 1) {
          ...
          // Columnas laterales con 2 elementos cada una
  ...
  const applyHexagonalStyles = (gridContainer) => {
    ...
    columnas.forEach((columna, index) => {
      ...
      if (totalItems === 5) {
        ...
        // Comportamiento por defecto para otros números
