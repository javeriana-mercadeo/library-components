        ...
        <div class="tools-content">
            <div class="tools-texto">
                ...
                <lfr-editable
                    ...
                    type="rich-text"
                    class="paragraph paragraph-neutral paragraph-md">
                    Lorem ipsum dolor sit amet consectetur. Eget id cursus eget at congue turpis. Volutpat
                    odio nisi dictum in congue. Suspendisse diam pellentesque volutpat donec consequat tempor
                    et quis sed. Leo sit donec scelerisque vitae risus senectus dignissim.
                </lfr-editable>
            </div>
