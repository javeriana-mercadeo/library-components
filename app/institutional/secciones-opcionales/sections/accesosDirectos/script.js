  ...
  var FloatingMenuNextJS = {
    ...
    loadPhosphorIcons: function () {
      ...
      try {
        ...
        link.onload = function () {
          console.log('Phosphor Icons cargados')
        }
        link.onerror = function () {
          console.warn('Error cargando Phosphor Icons')
        }
    ...
    initWhatsAppFallback: function () {
      ...
      this.addEventListener(whatsappButton, 'click', function (event) {
        ...
        var hasFaculty = (typeof window.currentFaculty !== 'undefined' && window.currentFaculty) || document.querySelector('[data-faculty]')
