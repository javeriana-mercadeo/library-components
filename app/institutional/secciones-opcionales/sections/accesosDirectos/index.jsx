      ...
      <div
        ...
        <div className='share-modal'>
          ...
          <div className='share-options'>
            ...
            <div className='share-option' data-share='facebook' tabIndex='0' role='button' aria-label='Compartir en Facebook'>
              <i className='ph ph-facebook-logo'></i>
              <span>Facebook</span>
            </div>
            <div className='share-option' data-share='instagram' tabIndex='0' role='button' aria-label='Compartir en Instagram'>
              <i className='ph ph-instagram-logo'></i>
              <span>Instagram</span>
            </div>
            <div className='share-option' data-share='linkedin' tabIndex='0' role='button' aria-label='Compartir en LinkedIn'>
              <i className='ph ph-linkedin-logo'></i>
              <span>LinkedIn</span>
            </div>
            <div className='share-option' data-share='email' tabIndex='0' role='button' aria-label='Compartir por correo electrónico'>
              <i className='ph ph-paper-plane-tilt'></i>
              <span>Correo</span>
            </div>
            <div className='share-option' data-share='copy' tabIndex='0' role='button' aria-label='Copiar enlace al portapapeles'>
