const SocialEmbed = ({ url, type = 'auto' }) => {
  // Función para detectar el tipo de red social automáticamente
  ...
  // Función para extraer el ID del post de Instagram
  ...
  const renderInstagramEmbed = () => {
    ...
    return (
      <div className="social-embed social-embed--instagram">
        <blockquote 
  ...
  const renderTikTokEmbed = () => {
    ...
    return (
      <div className="social-embed social-embed--tiktok">
        <blockquote 
  ...
  // Renderizar contenido por defecto para URLs no reconocidas
  const renderDefaultEmbed = () => (
    <div className="social-embed social-embed--default">
      <div style={{
        padding: '20px',
        textAlign: 'center',
