...
;(function () {
  ...
  function waitForLiferayReady() {
    return new Promise(resolve => {
      const checkReady = () => {
        const hasRequiredElements = document.getElementById('carousel-container') && document.getElementById('slides-wrapper')
  ...
  async function initializeComplete() {
    ...
    try {
      ...
      if (carouselOK) {
        ...
        console.log(
          'Funciones disponibles: debugCarousel(), debugMobileTablet(), debugBreakpoints(), debugVideoPlayers(), checkLastCardVisibility()'
        )
      } else {
