    ...
    <div className={baseClass} id={elementName}>
      <footer className={`${baseClass}__container`}>
        <div className={`${baseClass}__content`}>
          <h2 className={`${baseClass}__title`} data-lfr-editable-id='footer-title' data-lfr-editable-type='text'>
          ...
          <div className={`${baseClass}__icons-wrapper`}>
            <div className={`${baseClass}__contact-item`}>
              ...
              <p data-lfr-editable-id='footer-phone-text' data-lfr-editable-type='text'>
            ...
            <div className={`${baseClass}__contact-item`}>
              ...
              <a
                ...
                data-lfr-editable-id='footer-whatsapp-link'
                data-lfr-editable-type='link'>
                <p data-lfr-editable-id='footer-whatsapp-text' data-lfr-editable-type='text'>
                  +57 3164718453
                </p>
              </a>
            </div>
            ...
            <div className={`${baseClass}__contact-item`}>
              ...
              <p data-lfr-editable-id='footer-email-text' data-lfr-editable-type='text'>
            ...
            <div className={`${baseClass}__social-media`}>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                data-lfr-editable-id='footer-facebook-link'
                data-lfr-editable-type='link'>
              ...
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                data-lfr-editable-id='footer-instagram-link'
                data-lfr-editable-type='link'>
              ...
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                data-lfr-editable-id='footer-linkedin-link'
                data-lfr-editable-type='link'>
              ...
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                data-lfr-editable-id='footer-tiktok-link'
                data-lfr-editable-type='link'>
          ...
          <p className={`${baseClass}__legal-text`} data-lfr-editable-id='footer-legal-text' data-lfr-editable-type='text'>
          ...
          <p className={`${baseClass}__vigilance-text`} data-lfr-editable-id='footer-vigilance-text' data-lfr-editable-type='text'>
