          ...
          <div className={`${baseClass}__content`}>
            ...
            <div className={`${baseClass}__reasons-grid`}>
              ...
              <div className={`${baseClass}__reason-item`}>
                ...
                <div className={`${baseClass}__reason-text`} data-lfr-editable-id="diferenciales-reason-1" data-lfr-editable-type="rich-text">
              ...
              <div className={`${baseClass}__reason-item`}>
                ...
                <div className={`${baseClass}__reason-text`} data-lfr-editable-id="diferenciales-reason-2" data-lfr-editable-type="rich-text">
              ...
              <div className={`${baseClass}__reason-item`}>
                ...
                <div className={`${baseClass}__reason-text`} data-lfr-editable-id="diferenciales-reason-3" data-lfr-editable-type="rich-text">
              ...
              <div className={`${baseClass}__reason-item`}>
                ...
                <div className={`${baseClass}__reason-text`} data-lfr-editable-id="diferenciales-reason-4" data-lfr-editable-type="rich-text">
              ...
              <div className={`${baseClass}__reason-item`}>
                ...
                <div className={`${baseClass}__reason-text`} data-lfr-editable-id="diferenciales-reason-5" data-lfr-editable-type="rich-text">
              ...
              <div className={`${baseClass}__reason-item`}>
                ...
                <div className={`${baseClass}__reason-text`} data-lfr-editable-id="diferenciales-reason-6" data-lfr-editable-type="rich-text">
