...
class CardSlider extends React.Component {
  ...
  render() {
    const { currentIndex, cards, visibleCards, isMobile } = this.state
          ...
          <div className="cards-slider-wrapper">
            <div
              ...
              style={{
                ...
                gridTemplateColumns: `repeat(${cards.length}, calc(${cardWidth}% - ${((visibleCards - 1) * 10) / visibleCards}px))`
              }}>
              {cards.map((card, index) => (
                <div key={index} className={`card${isMobile ? ' mobile-card' : ''}`}>
                  <div className="card-header">
                    <div className="institution-info">
                      <div className="institution-logo">
                        <span>
                          <img src=" https://www.javeriana.edu.co/recursosdb/d/info-prg/logomultimedia" />
                        </span>
                      </div>
                  ...
                  <div className="card-content aspect-ratio-5-4">
...
class App extends React.Component {
  constructor(props) {
    ...
    this.cards = [
      ...
      },
      {
        institution: 'PUJ Javeriana',
        faculty: 'Facultad de Ingeniería',
        imageSrc: 'https://www.javeriana.edu.co/recursosdb/d/info-prg/multimedia2',
      ...
      },
      {
        institution: 'PUJ Javeriana',
        faculty: 'Facultad de Ingeniería',
        imageSrc: 'https://www.javeriana.edu.co/recursosdb/d/info-prg/multimedia3',
  ...
  render() {
    return (
      <div className="app">
        <CardSlider cards={this.cards} autoSlide={true} slideInterval={5000} />
      </div>
    )
  }
}
