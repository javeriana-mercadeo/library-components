...
// Compilado el: 01/10/2025, 03:52:53 p. m. (COT)
...
(() => {
  ...
  var processData = (programData, allPrograms, codPrg) => {
    const complementaryProgramData = DataUtils.filterBy(allPrograms, {
      codigo: codPrg
    })[0] || null;
    const consolidatedData = {
      mainProgram: DataUtils.deepMerge(
        programData,
        complementaryProgramData ? DataUtils.pick(complementaryProgramData, ["modalidad", "duracion", "unidadDuracion", "tituloOtorgado"]) : {}
      ),
