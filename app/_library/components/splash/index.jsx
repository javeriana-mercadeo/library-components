...
const LoadingSpinner = () => (
  <svg aria-hidden="true" role="status" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
...
/**
 * Componente Splash que muestra una pantalla de carga
 * Se oculta automáticamente después de que la aplicación carga
 */
const Splash = () => {
  useEffect(() => {
    script()
