  ...
  const scholarshipTabs = [
    {
      ...
      content: (
        <>
          <p>Contamos con un área de apoyo financiero que ofrece diferentes becas para que inicies tus estudios de pregrado.</p>
          <p>
          ...
          <ul>
            <li>
              <strong>Beca Ingresa a la Javeriana</strong>
            </li>
            <li>
              <strong>Beca Bachiller Destacado</strong>
            </li>
            <li>
              <strong>Beca Bachiller Destacado ACODESI</strong>
            </li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul>
            <li>
              <strong>A corto plazo</strong> directamente con la Universidad, tasa de interés preferencial.
            </li>
            <li>
              <strong>A mediano y largo plazo</strong> con entidades aliadas que ofrecen bajas tasas de interés.
            </li>
            <li>
              Conoce también, nuestros <strong>descuentos y convenios</strong> con entidades públicas y privadas.
            </li>
          </ul>
        </>
      ),
