          ...
          <footer className="container footer">
            <div className="footer__container">
              <div className="footer__left">
                <LogoBlanco alt="LogoBlanco " className="footer__logo light" />
              ...
              <div className="footer__middle">
                <div className="footer__video">
                  <div className="footer__mp4">
                    <img src={UniversidadTour.src} alt="Descripción del GIF" className="video-gif" />
                    <a
            ...
            <div className="footer__bottom">
              <div className="footer__vigilada">
                <img src={Vigilada.src} alt="Logo" className="footer__logoV" />
                <p className="footer__info">
                  Sujeta a inspección y vigilancia por parte del Ministerio de <br />
