...
const ModalInvestigacion = ({ investigacion, onClose }) => {
  ...
  const additionalImages = [`${investigacion.image}-2`, `${investigacion.image}-3`, `${investigacion.image}-4`]
      ...
      <div
        ...
        <div className='investigations-modal__gallery'>
          <div className='investigations-modal__images-container'>
            ...
            <div className='investigations-modal__image-wrapper'>
              <Image src={investigacion.image} alt={investigacion.alt} className='investigations-modal__image' loading='lazy' />
            </div>
        ...
        <div className='investigations-modal__content'>
          ...
          <div className='investigations-modal__header'>
            <button className='investigations-modal__close' onClick={onClose} aria-label='Cerrar modal' type='button'>
          ...
          <div className='investigations-modal__info'>
            ...
            {/* Título */}
            <Title hierarchy='h2' size='xl' weight='bold' className='investigations-modal__title' id='modal-title'>
              {investigacion.title}
            </Title>
            ...
            <div className='investigations-modal__description'>
              <Paragraph>{investigacion.description}</Paragraph>

              {/* Contenido adicional expandido */}
              <Paragraph>
                Esta investigación aborda los complejos desafíos que enfrentan las sociedades latinoamericanas en el siglo XXI, analizando
                desde una perspectiva interdisciplinaria los factores económicos, políticos y culturales que configuran la región.
              </Paragraph>

              <Paragraph>
                El estudio incluye un análisis comparativo entre diferentes países de la región, identificando patrones comunes y
                particularidades específicas que contribuyen a una mejor comprensión de la dinámica social contemporánea.
              </Paragraph>
            </div>
          </div>
        </div>
