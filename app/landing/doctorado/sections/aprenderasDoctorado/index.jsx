...
<section id="section-six">
  <div className="color-containerA">
    <div className="container expert-carousel" id="docentes">
      <h2 className="title title-neutral title-2xl title-center title-bold expert-carousel__titleA"
      ...
      <div className="contentGeneralA">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmv36c8jSv-3h7C7qV5RRZMrlUGi_0etVxLQ&s"
        ...
        <div className="doctoradoGrid">
          <div className="text-container-expandible" id="content-wrapper-unique">
            <div className="descriptionDoctoradoA"
