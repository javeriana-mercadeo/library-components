      ...
      <div className="documentation-links">
        ...
        <div className="documentation-item">
          <ul>
            ...
            <li>
              <strong>Beca Semestral por Excelencia Académica:</strong> 80% de la matrícula al estudiante con el mejor promedio ponderado de
              cada carrera.
            </li>
          </ul>
        </div>
        ...
        <div className="documentation-item">
          <ul>
            ...
            <li>
              <strong>Becas Fondo Rectoral:</strong> Apoyo financiero para estudiantes con dificultades económicas que impidan continuar sus
              estudios.
            </li>
          </ul>
        </div>
        ...
        <div className="documentation-item">
          <ul>
            ...
            <li>
              <strong>Beca Práctica Internacional:</strong> Reembolso del 50% de la matrícula para estudiantes que realicen prácticas en el
              exterior.
            </li>
            <li>
            ...
            <li>
              <strong>Beca Georgetown Law:</strong> 50% de la matrícula para un estudiante de Derecho destacado que curse un semestre en la
              Universidad de Georgetown, Londres.
            </li>
            <li>
            ...
            <li>
              <strong>Beca en Curso de Lengua para la Movilidad (CLM):</strong> Curso intensivo de francés, italiano o alemán con cobertura
              de libros y examen oficial.
            </li>
          </ul>
        </div>
