    ...
    <section className="inscription-container">
      <div className="item-inscription">
        <div className="help-header">
          <a href="/institutional/helpPage/questionFrequently" className="i-button">
            <h2>Proceso de Inscripción</h2>
            <i className="ph ph-arrow-up-right"></i>
          </a>
        </div>

        <p className="help-description">Todo lo que necesitas saber para inscribirte en la Universidad Javeriana.</p>
      ...
      <div className="item-inscription">
        <div className="help-header">
          <a href="/institutional/helpPage/financing/financingQuestionFrequently" className="i-button">
            <h2>Becas y Financiación</h2>
            <i className="ph ph-arrow-up-right"></i>
          </a>
        </div>

        <p className="help-description">Opciones de apoyo económico para facilitar tu ingreso a la universidad.</p>
        <ul className="help-questions">
      ...
      <div className="item-inscription">
        <div className="help-header">
          <a href="/institutional/helpPage/internationalization/internationalizationQuestionFrequently" className="i-button">
            <h2>Internacionalización y Movilidad</h2>
            <i className="ph ph-arrow-up-right"></i>
          </a>
        </div>
        <p className="help-description">Oportunidades de estudio en el extranjero y experiencias internacionales.</p>
        <ul className="help-questions">
